...
def get_cosmology():
    """
    Sets and returns the current cosmology.
    """
...
if __name__ == '__main__':
    ...
    ### set cosmology
    cosmos, H0, h, omega_M0, background_density_0 = get_cosmology()
    ### input your halo mass, particle mass, and redshift
    halo_mass = 1e12
    particle_mass = 2e-23
    current_redshift = 0

    print(f"halo mass: {halo_mass:.2e}, redshift: {current_redshift}, particle mass: {particle_mass}")

    ### Calculate the revised core mass
    revised_c_FDM_Mc = revised_theo_c_FDM_Mc(current_redshift, halo_mass, particle_mass)
    print(f"Predicted core mass (this work) : {revised_c_FDM_Mc}")
